                ...
                <div class="row">
                    <div class="signup">
                        <div class="signup_pannel">
                            <h1> Open Teacher Account </h1>
                            <p>Please fill the field below to Open Teacher Account</p>
                            <form class="register_form" method="post" action="">
                                ...
                                <div class="form-group">
                                    <div class="btn">
                                        <button class="register_button" value="Register" type="submit">Add Teacher</button>
                                    </div>
                                </div>
                            </form>
                        </div>
