        ...
        <div class="main">
            <div class="login_home_page">
                <div class="row">
                    ...
                    <div class="massage">
                        <h4><?php echo $_SESSION['massage']; ?></h4>
                    </div>
                    <div class="register_home">
                        <h1>Register as :</h1>
                        <a href="RegisterTeacher.php" class="sub2">Teacher</a>
                        <a href="RegisterStudent.php" class="sub3">Student</a>
                        <a href="RegisterStaff.php" class="sub1">Staff</a>
                    </div>
